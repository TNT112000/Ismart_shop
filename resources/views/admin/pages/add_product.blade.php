                    ...
                    <div class="section-detail">
                        <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="request_input">
                                ...
                                <input type="number" name="qty" id="product-qty">
                                @error('qty')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="request_input">
                                ...
                                <input type="number" name="transport" id="price">
                                @error('transport')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="request_input">
                                ...
                                <textarea name="describe" id="mytextarea"></textarea>
                                @error('describ')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function displaySelectedImages(images) {
                ...
                $('#selectedImagesContainer').prepend("<img src=" + imgThumbPath + " id='image_add'>");

                var numberOfItems = dataTransfer.items.length;

                // Số lượng tối đa mà bạn muốn giữ lại
                var maxImagesToKeep = 6;
                // Nếu số lượng hình ảnh nhiều hơn số lượng tối đa, xóa img-thumb.png
                if (numberOfItems > maxImagesToKeep) {
                    // Xóa img-thumb.png
                    $('#image_add').remove();
                }
            ...
            $('#selectedImagesContainer').on('click', '.delete-icon', function() {
                ...
                //     // alert(items[i].index)
                //         dataTransfer.items.remove(4);
                //         break; // Dừng lại sau khi xóa phần tử
                //     }
                // }
