        ...
        <div id="content" class="fl-right">
            <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <a href="{{route('line.create')}}" title="" id="add-new" class="fl-left">Thêm mới</a>
                </div>
            </div>
            @if (session('status'))
                                ...
                                <tr>
                                    ...
                                    <td class="clearfix">
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="{{route('line.edit',['line'=>$item->id])}}" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                            <li><a href="{{route('line.destroy',['line'=>$item->id])}}" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
